...
export function renderMembers(container) {
  ...
  container.innerHTML = `<header class="section-intro"><div><p class="eyebrow">MEMBERS / 團友確認表</p><h2 class="section-title">邊個去？酒店訂咗未？</h2><p class="muted">公開名單共 ${members.length} 人。O = 已確認，? = 待確認；兩間酒店狀態以公開快照為準，不公開付款細節或同一房型。</p></div></header>
